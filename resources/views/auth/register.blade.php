        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="name" 
                       ...
                       autofocus 
                       autocomplete="name"
                       class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200 @error('name') border-red-500 @enderror" 
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="password_confirmation" 
                       ...
                       required 
                       autocomplete="new-password"
                       class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200 @error('password_confirmation') border-red-500 @enderror" 
