    ...
    <div class="flex-1 flex flex-col pt-4 lg:pt-8">
        ...
        <main id="main-content" class="flex-1 p-3 sm:p-4 lg:p-6 xl:p-8 bg-gray-50 dark:bg-gray-900 overflow-y-auto">
            ...
            <div class="mb-4 sm:mb-6 lg:mb-8">
                <h1 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">Design Request </h1>
            </div>

            <!-- Content grid -->
            <div class="grid gap-4 sm:gap-6 lg:gap-8 mb-4 sm:mb-6 lg:mb-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700">
                        <div class="p-4 sm:p-5 lg:p-6 border-b border-gray-200 dark:border-gray-700">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
                                <h2 class="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">Design Request List </h2>
                            </div>
                        </div>
                            ...
                            <table class="w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-900 sticky top-0">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-2 sm:px-3 lg:px-4 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-150 hidden md:table-cell">Budget</th>
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    @forelse($consultations as $c)
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150">
                                            ...
                                            <td class="px-2 sm:px-3 lg:px-4 py-2 sm:py-3 whitespace-nowrap text-xs font-medium text-gray-900 dark:text-white hidden md:table-cell">{{ $c->budget_display_name }}</td>
                                            <td class="px-2 sm:px-3 lg:px-4 py-2 sm:py-3 whitespace-nowrap">
                                                @php
